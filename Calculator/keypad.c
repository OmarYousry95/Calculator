...
#if (N_COL == 3)
/* Function to map the switch number in the 4x3 keypad to its functional
 * number on proteus 4x3 keypad*/
static uint8 KEYPAD_4x3_adjustKeyNumber (uint8 button_number);

#elif (N_COL == 4)
/* Function to map the switch number in the 4x4 keypad to its functional
